...
extension UIView
{
    ...
    ///layout view under self, both must be subviews of the same superview
    func setBelow(view: UIView, offset: Float) {
        view.snp.makeConstraints{ $0.top.equalTo(self.snp.bottom).offset(offset)}
    }
